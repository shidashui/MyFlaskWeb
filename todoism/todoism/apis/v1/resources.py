...
class IndexAPI(MethodView):
    def get(self):
        ...
        return jsonify({
            ...
            'current_user_url': 'http://localhost:5000/api/v1/user',
            'authentication_url': 'http://localhost:5000/api/v1/token',
            'item_url': 'http://localhost:5000/api/v1/items/{item_id}',
            'current_user_items_url': 'http://localhost:5000/api/v1/user/items{?paage,per_page}',
            'current_user_active_items_url': 'http://localhost:5000/api/v1/user/items/active{?page,per_page}',
            'current_user_completed_items_url': 'http://localhost:5000/api/v1/user/items/completed{?page,per_page}',
        })
...
class ItemsAPI(MethodView):
    ...
    def get(self):
        ...
        return jsonify(items, current, prev, next, pagination)
